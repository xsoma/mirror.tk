...
#pragma endregion Contains the VTable Indexs
	...
	Functions::GetSeqActivity = game_utils::FindPattern1(strenc("client.dll"), strenc("55 8B EC 83 7D 08 FF 56 8B F1 74 3D"));
	Functions::dwGetPlayerCompRank = game_utils::FindPattern1(strenc("client.dll"), strenc("55 8B EC 8B 0D ? ? ? ? 68 ? ? ? ? "));

	Functions::IsReadySig = game_utils::FindPattern1(strenc("client.dll"), strenc("55 8B EC 83 E4 F8 83 EC 08 56 8B 35 ? ? ? ? 57 8B 8E"));

	Functions::dwIsReady = game_utils::FindPattern1(strenc("client.dll"), strenc("55 8B EC 83 E4 F8 83 EC 08 56 8B 35 ? ? ? ? 57 8B BE"));
