...
public:
	...
	void for_each_player(const std::function<void(IClientEntity*)> fn);
...
extern CInput::CUserCmd *get_inputcmd;
...
{
public:
	virtual bool            ShouldHitEntity(void* pEntity, int contentsMask) = 0; // IClientEntity* pEntity
...
{
public:
	CTraceFilterSkipEntity(IClientEntity* pEntityHandle) {
		pSkip = pEntityHandle;
	}
...
{
public:
	bool ShouldHitEntity(void* pEntityHandle, int contentsMask) // IClientEntity* pEntityHandle,
	{
		return !(pEntityHandle == pSkip);
	}
...
{
public:
	bool ShouldHitEntity(void* pEntityHandle, int contentsMask) // IClientEntity
	{
		return false;
	}
...
{
public:
	bool ShouldHitEntity(void* pServerEntity, int contentsMask) // IClientEntity 
	{
		return false;
	}
...
class CTraceFilterOneEntity : public ITraceFilter // pasted from sup I think
{
public:
	const IClientEntity* m_pass_ent1;
	...
	__forceinline void SetPassEntity(IClientEntity* pass_ent1) {
...
public:
	...
	{
		if (pServerEntity)
			return !pServerEntity->cs_player();
		return false;
	}
};
enum
