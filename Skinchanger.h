...
public:
	...
	inline void SetWeaponModel(const char* Filename, IClientUnknown* Weapon) {
		return fvv<void(__thiscall*)(void*, const char*, IClientUnknown*)>(this, 245)(this, Filename, Weapon);
	}

	f_netvar(int, m_nModelIndex, "CBaseEntity", "m_nModelIndex");
};
