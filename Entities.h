...
public:
	...
	f_netvar(int, m_iBurstShotsRemaining, "CWeaponCSBaseGun", "m_iBurstShotsRemaining");
	f_netvar(float, m_fNextBurstShot, "CWeaponCSBaseGun", "m_fNextBurstShot");
...
//	netvar(float, last_shot_time, "CWeaponCSBase->m_fLastShotTime");
	...
	int* m_nModelIndex()
	{
		return (int*)((uintptr_t)this + GET_NETVAR("DT_BaseViewModel", "m_nModelIndex"));
	}
	int* ViewModelIndex()
	{
		return (int*)((uintptr_t)this + GET_NETVAR("DT_BaseCombatWeapon", "m_iViewModelIndex"));
	}
	bool IsGrenade()
	{
		if (this) {
	...
	float GetInaccuracy() {
		return call_vfunc<float(__thiscall*)(void*)>(this, 482)(this);
	}
	...
	int get_weapon_type() { if (!this) return -1; return this->GetCSWpnData()->iWeaponType; }
	bool m_bIsSniper()
	{
	...
	float GetSpread()
	{
		...
		return call_vfunc<OrigFn>(this, 452)(this);
	}
	...
	void UpdateAccPenalty()
	{
		...
		return call_vfunc<OrigFn>(this, 483)(this);
	}
	...
	CSWeaponInfo* GetCSWpnData() {
		return call_vfunc<CSWeaponInfo*(__thiscall*)(void*)>(this, 460)(this);
	}
};
...
public:
	...
	float m_fl_last_csanim_updatetime; //0x6C
	int m_last_csanim_framecount; //0x70
	...
	unsigned char m_onground; //0x108
...
public:
	...
	f_netvar(float, m_flNextAttack, "DT_CSPlayer", "m_flNextAttack");
//	offset(int, get_eflags, 0x44);
	...
	{
		return call_vfunc <void(__thiscall*)(IClientEntity*, int)>(this, 75)(this, index);
	}
	f_netvar(float, m_flDuckAmount, "DT_BasePlayer", "m_flDuckAmount");
	offset(int, get_eflags, 0x44);
	offset(vector, get_abs_velocity, 0x94);
	...
	bool cs_player()
	{
		return call_vfunc<bool(__thiscall*)(IClientEntity*)>(this, 157)(this);
	}
...
//	std::string GetName();
	...
	bool SetupBonesEx();
	void create_animation_state(CBaseAnimState * state);
	...
	CNETVAR_FUNC(float, get_lowerbody, 0xE6996CCF); //m_flLowerBodyYawTarget // 0x3A0C 0xE6996CCF
...
//	CNETVAR_FUNC(int, team, 0xC08B6C6E); //m_iTeamNum
	...
	f_netvar(float, m_flPoseParameter, "DT_BaseAnimating", "m_flPoseParameter");
	f_netvar(float, duck, "DT_BasePlayer", "m_flDuckAmount");
	f_netvar(float, health_boost_time, "DT_CSPlayer", "m_flHealthShotBoostExpirationTime");
	f_netvar(int, m_hActiveWeapon,"DT_BaseCombatCharacter", "m_hActiveWeapon")
	...
	CNETVAR_FUNC(vector, get_visual_angles, 0x31D8);
...
//	}
	...
	void IClientEntity::SetAbsOriginal(vector origin)
	{
		...
		if (!SetAbsOrigin)
			SetAbsOrigin = (SetAbsOriginFn)((DWORD)Utilities::Memory::FindPatternV2(("client.dll"), "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8"));
		SetAbsOrigin(this, origin);
	}
	matrix3x4* bone_cache() {
		if (!this)
			return nullptr;

		static auto offset = *(uint32_t*)(Utilities::Memory::FindPatternV2("client.dll", ("FF B7 ? ? ? ? 52")) + 2);
		return *(matrix3x4**)(std::uintptr_t(this->GetRenderable()) + offset);
	}
	...
	void IClientEntity::set_abs_angles_v2(const vector & angles)
	{
		...
		static auto _set_abs_angles = (void(__thiscall*)(void*, const vector&)) Utilities::Memory::FindPatternV2("client.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8");
	...
	{
		using SetAbsOriginFn = void(__thiscall*)(void*, const vector &origin);
		static SetAbsOriginFn SetAbsOrigin = (SetAbsOriginFn)(Utilities::Memory::FindPatternV2(("client.dll"), "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8"));
	...
	void UpdateClientSideAnimation()
	{
		...
		call_vfunc<o_updateClientSideAnimation>(this, 223)(this);
	}
...
//	}
	...
	*/
	...
	QAngle* get_eyeangles()
	{
		return (QAngle*)((DWORD)this + GET_NETVAR("DT_CSPlayer", "m_angEyeAngles"));
	}

	float* get_lowerbodyTarget() /*m_flLowerBodyYawTarget*/
	{
	...
	void SetAngle2(vector wantedang) {
		...
		static oSetAngle _SetAngle = (oSetAngle)((uintptr_t)Utilities::Memory::FindPatternV2("client.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1"));
	...
	bool IsMoving()
	{
		return getvelocity().length2d() > 2.02f;
	}
	vector GetOrigin2() {
		return *(vector*)((DWORD)this + 0x00000134);
	}
	...
	int get_sequence_act(int sequence, IClientEntity * player);
