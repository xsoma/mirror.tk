...
public:
	...
	void mirror_adaptive_reworked(bool & packet, IClientEntity * local, int ammount, bool break_lc);

	void antiaim_specific(bool & packet, IClientEntity * local, int ammount, bool break_lc);
